...
import styles from "./styles_backup.module.css"
import { Gauge } from '@mui/x-charts/Gauge';
import { useState, useEffect} from "react";
import AddFoodModal from "../foodmodal_backup/foodmodal";
...
export default function DashboardPage(){
    ...
    const getGoal = async () => {
        ...
        const response = await fetch(`/api/showgoal?userId=${userId}`);
    ...
    useEffect(() => {
        ...
        const getProducts = async () => {
            const response = await fetch(`/showproduct?userId=${userId}`);
            const data = await response.json();
            setproduct(data);
        };
        if (!userId) return;
...
return(
    ...
    ===========================================*/}
        <header className={styles.header}>
            <p>Calorie Tracker</p>
            <button  className={styles.addgoals} onClick={handleLogout}> Log out </button>
         </header>
                ...
                <section className={styles.meals_section}>
                    ...
                    ==========================*/}
                     ...
                     <div className={styles.meal_card}>
                        ...
                        <button className={styles.add_food_button} onClick={() => {setshowModal(true); setmealType("dinner")}}>
                            + Add food
                        </button>
                    </div>
                </section>
